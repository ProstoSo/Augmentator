...
from augmentations import FirstAugmentation, Second_augmantation, ThirdAugmentation, FourthAugmentation, \
    FifthAugmentation, SixthAugmentation
...
AUGMENTATIONS = {
    ...
    'change_number_2_aug': AugChangeNumberWithRange,
